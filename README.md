...
### 📋 Prerequisites
- GCC/G++ compiler (`g++ --version`) or Microsoft C++ Build Tools.
...
No external dependencies detected. The script should run stand-alone.
